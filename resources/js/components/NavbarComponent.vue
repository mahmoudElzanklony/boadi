            ...
            <div class="collapse navbar-collapse  justify-content-between" id="navbarSupportedContent">
                <ul class="d-flex align-items-center">
                    <li class="nav-item" v-if="user != null && user.role_id == 1">
                        <inertia-link class="font-weight-bold" href="/dashboard">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        <inertia-link href="/aboutbook" class="nav-link">
                            <span>{{ switchWord('about_book') }}</span>
                        </inertia-link>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <inertia-link href="/contactus" class="nav-link">
                            <span>{{ switchWord('contact_us') }}</span>
                        </inertia-link>
                    </li>
                </ul>
                <ul class="d-flex align-items-center" v-if="false">
